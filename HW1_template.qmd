...
9)  Using the **diamonds** data, create a scatterplot of two numerical variables with an aesthetic mapped to the values a third variable categorical which is categorical. Your scatterplot should also have a single smoothing line overlaid.
